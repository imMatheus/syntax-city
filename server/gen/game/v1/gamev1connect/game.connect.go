...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/imMatheus/syntax-city/server/gen/game/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	GameServiceGetGameProcedure = "/game.v1.GameService/GetGame"
)

// These variables are the protoreflect.Descriptor objects for the RPCs defined in this package.
var (
	gameServiceServiceDescriptor       = v1.File_game_v1_game_proto.Services().ByName("GameService")
...
// GetGame calls game.v1.GameService.GetGame.
...
func (UnimplementedGameServiceHandler) GetGame(context.Context, *connect.Request[v1.GetGameRequest]) (*connect.Response[v1.GetGameResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("game.v1.GameService.GetGame is not implemented"))
}
